...
class CovidData extends Component {
  ...
  render() {
    ...
    const newData = [
      ...
      { name: 'Page C', uv: 200, pv: 800, amt: 800 },
    ];
    return (
      <div className='data'>
        <div className='resultsDiv'>
          ...
          />
          <div className='usa'>
            <h3 className='results1'>Positive Test: </h3>
            <h2>{countryData.positive}</h2>
            <h3 className='results1'>Total Deaths: </h3>
            <h2>{countryData.death}</h2>
            <h3 className='results1'>Total Cases: </h3>
            <h2>{countryData.total} </h2>
          </div>
        </div>
        <div className='resultsDiv2'>
          ...
          <img
            src={`http://flags.ox3.in/svg/us/${lcState}.svg`}
            className='flag2'
            alt='state flag'
          />
          <div>
